...
#define GETR_FROM_RGB16(RGB565)  ((unsigned char)(RGB565>>16))		  			//返回8位 R
#define GETG_FROM_RGB16(RGB565)  ((unsigned char)(RGB565>>8)) 	//返回8位 G
#define GETB_FROM_RGB16(RGB565)  ((unsigned char)RGB565)      //返回8位 B
